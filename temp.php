...
<html>
<head>
	<title>View and edit blogs</title>
...
<body style="padding: 70px;">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
			  <div class="container-fluid" >
			    ...
			    <ul class="nav navbar-nav">
			      ...
			      <li class="active"><a href="temp.php">View posts</a></li>
			    </ul>
	...
	<div id="container">
		...
		<article>
			...
			<p><?php echo substr($body, 0, $lastspace). "<a href='post.php?id=$blog_id'> Read more....</a>" ?></p>
		</article><br>
		<?php endwhile ?>
	</div>
	<br>
	<div style="display: flex;">
		...
		<?php
			if($prev > 0)
				echo "<a href='temp.php?p=$prev' style='font-size: 20px'>..Prev</a>";
		...
		<?php
		 	if($page < $pages){
				echo "<a href='temp.php?p=$next' style='font-size: 20px'>Next..</a>";
			}
